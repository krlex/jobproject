Vagrant.configure("2") do |config|
 config.vm.define "web" do |web|
  web.vm.box = "fujimakishouten/debian-stretch64"
  web.vm.hostname = 'web'
 ...
 config.vm.define "srv1web" do |srv1web|
  srv1web.vm.box = "fujimakishouten/debian-stretch64"
 ...
 config.vm.define "srv2web" do |srv2web|
  srv2web.vm.box = "fujimakishouten/debian-stretch64"
 ...
 config.vm.define "dbweb" do |dbweb|
  dbweb.vm.box = "fujimakishouten/debian-stretch64"
